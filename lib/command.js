...
(function() {
  var content, content2json, contents, format, fs, input, isDirectory, isNewer, markup, parser, program, yaml2json, _, _i, _len;
  ...
  program.format = format || markup.detect(input);
